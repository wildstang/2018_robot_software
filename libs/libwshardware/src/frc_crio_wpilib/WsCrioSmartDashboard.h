#ifndef __WSCRIOSMARTDASHBOARD_H__
#define __WSCRIOSMARTDASHBOARD_H__

#include "logger/WsSmartDashboard.h"

class WsCrioSmartDashboard : public WsSmartDashboard
{
    public:
        WsCrioSmartDashboard( void );
        virtual ~WsCrioSmartDashboard( void );
